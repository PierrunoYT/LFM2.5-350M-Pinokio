# LFM2.5-350M — WebGPU Chat (Pinokio)

In-browser text generation powered by [LiquidAI/LFM2.5-350M](https://huggingface.co/LiquidAI/LFM2.5-350M) via [transformers.js](https://huggingface.co/docs/transformers.js) and WebGPU. No GPU server required — the model runs entirely in your browser.
...
3. **Open Web UI** — Click "Open Web UI" to open the chat interface
